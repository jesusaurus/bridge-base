...
public class BcCmsSignedDataProcessorTest {
    ...
    public void test() throws Exception {
        ...
        Certificate cert = certFactory.newCertificate(keyPair, new CertificateInfo.Builder().build());
        ...
        String base64Encoded = Base64.encodeToString(text.getBytes(StandardCharsets.UTF_8));
